export const filterData = [ {name:"Ride",image: require('./assets/ride.jpg'), id:"0"},
                            {name:"Food",image:require("./assets/food.jpg"),id:"1"},
                            {name:"Package",image:require("./assets/package.jpg"),id:"2"},
                            {name:"Reserve",image:require("./assets/reserve.jpg"),id:"3"}
